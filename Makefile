...
aktakurvan.%: S=master.vhd ram.vhd gpu.vhd alu.vhd controller.vhd greg.vhd areg.vhd mux.vhd cpu.vhd gpu_display_numbers.vhd uart.vhd leddriver.vhd gpu_text.vhd
aktakurvan.%: T=tb.vhd
